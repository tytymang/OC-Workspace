...
[System.Windows.Forms.MessageBox]::Show("마당쇠 실시간 변환기가 백그라운드에서 실행되었습니다.`n`n[사용법]`n아웃룩 본문에서 이름을 치고 바로 'Ctrl + Shift + Q' 단축키를 누르세요.", "마당쇠 실행 완료", 0, [System.Windows.Forms.MessageBoxIcon]::Information)
