...
메일 보고 양식: [편지함], 보낸사람(한글명칭), 보낸시간, 제목, 내용 요약, 회신/요청사항을 포함한 표 형식으로 보고 (받은 편지함 및 모든 하위 폴더 포함)
...
회의 준비: "회의 준비해" 지시 시 클로바노트 접속 후 새 노트 녹음 시작
회의 종료: "회의 종료해" 지시 시 녹음 종료 및 회의록 요약 보고
